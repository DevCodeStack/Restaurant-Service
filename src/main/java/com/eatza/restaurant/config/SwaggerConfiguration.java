...
//			        .select()
//			        .apis(RequestHandlerSelectors.basePackage("com.eatza.restaurant"))
...
//		return builder.title("Restaurant Service APIs")
//				.description("Restaurant service for eatza restaurants")
//				.version("0.0.1")
//				.build();
//	}
